...
// Плани в спільній Google Таблиці мають лишатися свіжими без того, щоб хтось
// щоранку натискав «Вивантажити». О 06:40 — навмисно до 07:00: після
// автогенерації звітів вивантаження чекало б у черзі `default` за всіма
// звітами команди, тобто до обіду.
Schedule::command('plans:sync-google')
    ->dailyAt('06:40')
    ->timezone('Europe/Kyiv')
    ->withoutOverlapping()
    ->appendOutputTo(storage_path('logs/scheduler.log'));
